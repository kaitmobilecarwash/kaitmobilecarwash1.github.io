[index.html](https://github.com/user-attachments/files/23394329/index.html)
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Kait Mobile Car Wash – Book Online</title>
  <meta name="description" content="Kait Mobile Car Wash – Fast, affordable mobile car washing in Port Moresby. Book online via WhatsApp." />
...
<body>
    ...
    <div class="nav-inner container">
      <div class="brand">
        ...
        <div>
          ...
          <small class="muted">Port Moresby • We come to you</small>
        </div>
      </div>
      <div class="cta">
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div>
        ...
        <div class="muted" style="margin-top:10px">Open 7 days • 8:00–18:00 PGT</div>
      </div>
  ...
  <section id="book" class="section">
    <div class="container">
      <div class="card shadow-xl">
        ...
        <p class="muted" style="margin:0 0 18px">Fill this form and we’ll confirm on WhatsApp. You can also call <a href="tel:+67581803161">+675 8180 3161</a>.</p>
        <form id="bookingForm" autocomplete="on">
          ...
          <div style="margin-top:12px">
            ...
            <textarea id="notes" name="notes" rows="3" placeholder="e.g., Toyota Hilux, pet hair, child seats…"></textarea>
          </div>
  ...
  <section class="section">
    <div class="container">
      <div class="card">
        ...
        <p class="muted" style="margin:0 0 12px">Fastest response. Tap below to start a chat and we’ll confirm your booking.</p>
  ...
  <footer class="footer">© <span id="year"></span> Kait Mobile Car Wash • Port Moresby, PNG</footer>
